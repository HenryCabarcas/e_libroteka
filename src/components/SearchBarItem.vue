        ...
        refreshToken().then(result => {
          const body = {
            book: {
              ...
              gender: this.all.volumeInfo.categories ? this.all.volumeInfo.categories.join(", ") : "Undefined",
              author: this.author !== undefined && this.author.length > 0 ? this.author : "Undefined",
